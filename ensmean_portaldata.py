...
def process_data(model,experiment,var,basepath):
	...
	try:		
		...
		outmean = '/export/silurian/array-01/pu17449/processed_data/'+model+'.'+var+'.'+experiment+'_ensmean.nc'
		outstd = '/export/silurian/array-01/pu17449/processed_data/'+model+'.'+var+'.'+experiment+'_ensstd.nc'
		...
		for runpath in runs:
			...
			# Only one file, use this
				run_whole = run_files[0]
			else: 
			# concatenate files
...
if __name__=='__main__':
	...
	vars = ['pr','tas','tasmin','tasmax','rsds']

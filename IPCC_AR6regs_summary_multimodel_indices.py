...
if __name__=='__main__':
	...
	if host=='triassic.ggy.bris.ac.uk':
		...
		modelsummary_pkl = '/export/anthropocene/array-01/pu17449/pkl/AR6regs/'+summary_name+'models_'+index+'_AR6reg_summary3.pkl'
		numthreads = 12
		...
		modelsummary_pkl = '/home/users/pfu599/pkl/'+summary_name+'models_'+index+'_AR6regs_jasmin_summary.pkl'
